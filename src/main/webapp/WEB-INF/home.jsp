	...
	<div class="container">
		...
		<div class="content">
			...
			<ul class="d-flex justify-content-around">
				<li class="menu"><a>Most Popular Recipes</a></li>
				<li class="menu"><a>My Recipes</a>
			...
			<div class="content row">
				...
				<div class="recipes col-9 border border-secondary ml-3 row p-3">
						...
						<c:forEach items="${ recipes }" var="recipe">
							<div class="singlerecipe bg-light">
								<img>${recipe.photo }</img>
								<p> ${ recipe.author }</p>
								<h5> ${ recipe.name }</h5>
								<i class="bi bi-hand-thumbs-up">${ recipe.likers.size() }</i>
							</div>
						</c:forEach>
				</div>
